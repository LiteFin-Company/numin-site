...
export const FAQ = [
  ...
  { q: "Qual a diferença entre os planos?", a: "Todas as funcionalidades estão em todos os planos. O que muda é o tamanho da equipe (2, 5 ou 15 membros) — e a API pública, disponível nos planos Profissional e Avançado." },
