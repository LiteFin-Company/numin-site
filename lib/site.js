import {
  ...
  Landmark, KeyRound, ScrollText, Lock, Scale,
} from "lucide-react";
...
// Oferta Parceiros Numin (early adopter) — limitada: meses grátis e depois preço fixo para sempre
...
// (exceto a API pública, restrita aos planos Profissional e Avançado).
...
export const FAQ = [
  ...
  { q: "Qual a diferença entre os planos?", a: "Todas as funcionalidades estão em todos os planos. O que muda é o tamanho da equipe (2, 5 ou 10 membros) — e a API pública, disponível nos planos Profissional e Avançado." },
